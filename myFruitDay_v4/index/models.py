...
class User(models.Model):
  uphone = models.CharField(max_length=32,verbose_name='手機號碼')
  upwd = models.CharField(max_length=100,verbose_name='密碼')
  ...
  auth_id = models.IntegerField(default=0,verbose_name='第三方用戶id')
  def __repr__(self):
